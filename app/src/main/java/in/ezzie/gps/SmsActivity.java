...
public class SmsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private EditText inputName, inputVehicle, inputMobile, inputOtp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputVehicle = (EditText) findViewById(R.id.inputVehicle);
    ...
    private void validateForm() {
        ...
        String vehicle_reg_no = inputVehicle.getText().toString().trim();
        String mobile = inputMobile.getText().toString().trim();

        // validating empty name and vehicle_reg_no
        if (name.length() == 0 || vehicle_reg_no.length() == 0) {
        ...
        if (isValidPhoneNumber(mobile)) {
            ...
            // requesting for sms
            requestForSMS(name, vehicle_reg_no, mobile);
     ...
     *
     */
    private void requestForSMS(final String name, final String vehicle_reg_no, final String mobile) {
        MultiValueMap<String, String>  params = new LinkedMultiValueMap<String, String>();
        params.add("name", name);
        params.add("vehicle_reg_no", vehicle_reg_no);
        params.add("mobile", mobile);
        new SendRequestTask(params).execute();
    }
    ...
    private class SendRequestTask extends AsyncTask<Void,Void,responseMessage>{
        private MultiValueMap<String, String> params;

        public SendRequestTask(MultiValueMap<String, String> params){
            this.params = params;
        }
        @Override
        ...
        protected responseMessage doInBackground(Void... voids) {
            return Config.sendData(Config.URL_REQUEST_SMS,this.params,TAG);
        }
        ...
        protected void onPostExecute(responseMessage s) {
            ...
            Toast.makeText(SmsActivity.this,s.getMessage(),Toast.LENGTH_LONG).show();
